...
func TestQueryBoolParam(t *testing.T) {
	...
	t.Run("valid", func(t *testing.T) {
		r := httptest.NewRequest(http.MethodGet, "/?flag=true", nil)
		w := httptest.NewRecorder()
	...
	t.Run("invalid", func(t *testing.T) {
		r := httptest.NewRequest(http.MethodGet, "/?flag=nope", nil)
		w := httptest.NewRecorder()
...
func TestQueryFloatParam(t *testing.T) {
	...
	t.Run("valid", func(t *testing.T) {
		r := httptest.NewRequest(http.MethodGet, "/?lat=52.5", nil)
		w := httptest.NewRecorder()
	...
	t.Run("invalid", func(t *testing.T) {
		r := httptest.NewRequest(http.MethodGet, "/?lat=nope", nil)
		w := httptest.NewRecorder()
...
func TestGeoObjectFilterFromQuery(t *testing.T) {
	t.Run("no bbox params", func(t *testing.T) {
		r := httptest.NewRequest(http.MethodGet, "/?name=hydrant&createdBy=bob", nil)
		w := httptest.NewRecorder()
	...
	t.Run("full bbox", func(t *testing.T) {
		r := httptest.NewRequest(http.MethodGet, "/?minLat=1&maxLat=2&minLon=3&maxLon=4", nil)
		w := httptest.NewRecorder()
	...
	t.Run("partial bbox is rejected", func(t *testing.T) {
		r := httptest.NewRequest(http.MethodGet, "/?minLat=1&maxLat=2", nil)
		w := httptest.NewRecorder()
	...
	t.Run("invalid bbox number", func(t *testing.T) {
		r := httptest.NewRequest(http.MethodGet, "/?minLat=nope", nil)
		w := httptest.NewRecorder()

...
func MapAliasesListHandler(st *store.Store) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httputil.WriteJSON(w, http.StatusOK, aliases)
	}
}
...
func MapAliasGetHandler(st *store.Store) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		httputil.WriteJSON(w, http.StatusOK, store.MapVersionAlias{Alias: alias, Version: version})
	}
}
...
func MapAliasSetHandler(st *store.Store) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		a, err := st.SetMapVersionAlias(r.Context(), id, alias, req.Version, auth.UsernameFromContext(r.Context()))
		if err != nil {
